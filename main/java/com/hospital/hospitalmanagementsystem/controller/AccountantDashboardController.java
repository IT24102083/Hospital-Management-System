...
public class AccountantDashboardController {
    ...
    public String showPOSTerminal(Model model) {
        try {
            List<Payment> recentTransactions = paymentService.getRecentPOSTransactions(10);
    ...
    public String processPOSPayment(@RequestParam String customerType,
        ...
        try {
            ...
            return "redirect:/accountant/pos-terminal";
        }
    }
    ...
    public String showBankSlipsForVerification(Model model, Pageable pageable) {
        try {
            ...
            return "home/accountant/bank-slip-verification"; // Changed to a more appropriate view name
        } catch (Exception e) {
